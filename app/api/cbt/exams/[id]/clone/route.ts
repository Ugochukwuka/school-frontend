...
/**
 * POST /api/cbt/exams/:id/clone
 * Proxies to backend POST /api/cbt/exams/:id/clone.
...
export async function POST(
  ...
  try {
    const res = await fetch(`${backendUrl}/api/cbt/exams/${id}/clone`, {
      method: "POST",
      headers: {
