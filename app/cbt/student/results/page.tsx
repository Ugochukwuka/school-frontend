...
import { Search, Trophy, TrendingUp, TrendingDown, Eye } from "lucide-react";
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
export default function StudentResultsPage() {
  ...
  const results = [
    { id: 1, examId: 5, examTitle: "Chemistry Practical", subject: "Chemistry", date: "2026-02-28", score: 88, totalMarks: 100, percentage: 88, grade: "A", duration: "58 mins", rank: 3, totalStudents: 45 },
    { id: 2, examId: 6, examTitle: "Biology Quiz", subject: "Biology", date: "2026-02-25", score: 92, totalMarks: 100, percentage: 92, grade: "A", duration: "42 mins", rank: 1, totalStudents: 45 },
    { id: 3, examId: 7, examTitle: "History Test", subject: "History", date: "2026-02-22", score: 78, totalMarks: 100, percentage: 78, grade: "B", duration: "55 mins", rank: 12, totalStudents: 45 },
    { id: 4, examId: 8, examTitle: "Mathematics Assignment", subject: "Mathematics", date: "2026-02-18", score: 95, totalMarks: 100, percentage: 95, grade: "A+", duration: "50 mins", rank: 2, totalStudents: 45 },
  ];
                  ...
                  <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                    ...
                    <Dialog>
                      <DialogTrigger asChild>
                        <Button className="lg:w-auto w-full bg-slate-100 hover:bg-slate-200 text-slate-800 border-0 shadow-none rounded-lg">
                      ...
                      <DialogContent className="max-w-2xl">
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="p-4 rounded-lg bg-white shadow-[0_1px_2px_0_rgba(0,0,0,0.05)]">
